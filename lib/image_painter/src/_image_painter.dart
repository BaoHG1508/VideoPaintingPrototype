...
class PaintInfo {
  ...
  PaintInfo.fromJson(Map<String, dynamic> json)
      : mode = PaintMode.values[json['mode']],
        ...
        offset = [
          Offset(json['offset']['first'][0], json['offset']['first'][1]),
          Offset(json['offset']['second'][0], json['offset']['second'][1])
        ];

  Map<String, dynamic> toJson() => {
        'mode': mode!.index,
        'paint': {
          'style': painter!.style.index,
          'strokeWidth': painter!.strokeWidth,
          'color': painter!.color.value,
        },
        'offset': {
          'first': [offset![0]!.dx, offset![0]!.dy],
          'second': [offset![1]!.dx, offset![1]!.dy],
        },
      };
}
